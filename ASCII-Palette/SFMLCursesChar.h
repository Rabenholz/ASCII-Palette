...
{
public:
	SFMLCursesChar(const sf::Window& window, char character);
	SFMLCursesChar(const sf::Window& window, char character, const sf::Color& textColor, const sf::Color& backgroundColor);
	~SFMLCursesChar(void);
